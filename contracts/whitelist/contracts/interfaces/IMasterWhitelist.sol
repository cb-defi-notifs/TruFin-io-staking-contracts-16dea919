...
/// @notice Interface for contract that manages the whitelists for: Lawyers, Market Makers, Swap Managers, Users, Vaults, and Assets.
interface IMasterWhitelist {
    ...
    /// @notice Returns true if address is a lawyer.
    /// @param _lawyer address that is potentially a lawyer.
